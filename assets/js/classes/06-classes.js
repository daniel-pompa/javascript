...
console.log('area' in Square.prototype);
console.log('area' in Rectangle.prototype);
console.log('area' in Triangle.prototype);
...
// Expected output:
// Shape { _area: 16, side: 4 }
// Área del cuadrado: 16
// Shape { _area: 20, base: 4, height: 5 }
// Área del rectángulo: 20
// Shape { _area: 10, base: 4, height: 5 }
// Área del triángulo: 10
// Shape { _area: 28.274333882308138, radius: 3 }
